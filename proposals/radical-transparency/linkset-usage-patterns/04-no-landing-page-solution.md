...
Link: <resource-pid-uri>; rel=describes
```
...
The following link relations are mandated for declaring the machine-readable links between digital assests and their available metadata descriptions without the strict need of optional human centric (HTML) descriptive pages:
...
{ "linkset":
  [
    { "anchor"       : "https://marineinfo.org/id/dataset/1447",
      "describes"    : [ {"href": "https://doi.org/10.14284/170" }],
      "alternate"    : [
    ...
    { "anchor"       : "https://doi.org/10.14284/170",
